 ...
 */
class ClientAdress extends \Deliverme\MenuBundle\Entity\ClientAdress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\ClientAdress' . "\0" . 'id', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\ClientAdress' . "\0" . 'adress', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\ClientAdress' . "\0" . 'zipCode', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\ClientAdress' . "\0" . 'title', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\ClientAdress' . "\0" . 'data_created', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\ClientAdress' . "\0" . 'data_updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClientAdress $proxy) {
