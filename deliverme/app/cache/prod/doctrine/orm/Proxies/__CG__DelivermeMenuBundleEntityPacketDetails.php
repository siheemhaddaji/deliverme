 ...
 */
class PacketDetails extends \Deliverme\MenuBundle\Entity\PacketDetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\PacketDetails' . "\0" . 'id', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\PacketDetails' . "\0" . 'price', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\PacketDetails' . "\0" . 'amount', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\PacketDetails' . "\0" . 'packet', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\PacketDetails' . "\0" . 'data_created', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\PacketDetails' . "\0" . 'data_updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PacketDetails $proxy) {
