 ...
 */
class Packet extends \Deliverme\MenuBundle\Entity\Packet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Packet' . "\0" . 'id', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Packet' . "\0" . 'price', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Packet' . "\0" . 'startDate', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Packet' . "\0" . 'endDate', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Packet' . "\0" . 'data_created', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Packet' . "\0" . 'data_updated'];
        }
