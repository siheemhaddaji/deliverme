 ...
 */
class Client extends \Deliverme\MenuBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Client' . "\0" . 'firstName', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Client' . "\0" . 'lastName', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Client' . "\0" . 'user', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Client' . "\0" . 'data_created', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\Client' . "\0" . 'data_updated'];
        }
