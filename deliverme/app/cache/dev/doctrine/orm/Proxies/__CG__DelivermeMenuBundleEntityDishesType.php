 ...
 */
class DishesType extends \Deliverme\MenuBundle\Entity\DishesType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\DishesType' . "\0" . 'id', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\DishesType' . "\0" . 'name', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\DishesType' . "\0" . 'status', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\DishesType' . "\0" . 'ranking', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\DishesType' . "\0" . 'data_created', '' . "\0" . 'Deliverme\\MenuBundle\\Entity\\DishesType' . "\0" . 'data_updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DishesType $proxy) {
